...
const handleSignUp = async(e)=>{
  if(userType=="Admin" && secretKey!="GDSC"){
    e.preventDefault();
    alert("Invalid Admin")
  }else{
  e.preventDefault();
...
setIsClicked(false)
  ...
  return (
    <>
      <section className="signup_page h-screen flex flex-col md:flex-row justify-evenly space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      <div className=' top-1/3 left-30 font-semibold'>
          <span className='text-2xl md:text-5xl text-white'>Life is not measured  </span><br />
          <span className='text-2xl md:text-4xl text-white'>by the number of breaths</span><br />
          <span className='text-2xl md:text-3xl text-white'> we take,</span><br />
          <span className='text-2xl md:text-2xl text-white'> but by the moments that take our breath away.</span>
      </div>
      <div className="md:w-3/4 max-w-sm bg-gray-200 p-4 rounded-md shadow-md border border-white">
