...
const Login = ({setLoginUser,setIsloggedIn}) => {
  ...
  return (
    <div>
            <section className="login_page h-screen flex flex-col md:flex-row justify-evenly space-y-10 md:space-y-0 md:space-x-16 items-center mx-5 md:mx-0 md:my-0 ">
